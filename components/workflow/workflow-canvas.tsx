...
import { addEdge, addNode, deleteNodes, moveNode, updateNodeConfig, validateForPublish, validateWorkflow, type NodeConfig, type NodeType, type Workflow } from "@/domain";
...
function CanvasEditor({ workflowId }: { workflowId?: string }) {
  ...
  const publishValidation = useMemo(() => validateForPublish(workflow), [workflow]);
