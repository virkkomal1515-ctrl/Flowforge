...
function CanvasEditor({ workflowId }: { workflowId?: string }) {
  ...
  return <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    ...
    <p className="border-t border-slate-200 px-4 py-3 text-xs text-slate-500">Workflow data is persisted through the domain persistence API; React Flow state remains an adapter representation.</p>
  </div>;
}
